...
namespace Aliencube.XslMapper.FunctionApp.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// </summary>
        /// <param name="value">A string that contains the value of either <see cref="bool.TrueString"/> or <see cref="bool.FalseString"/>.</param>
        /// <returns><c>true</c> if value equals <see cref="bool.TrueString"/>, or <c>false</c> if value equals <see cref="bool.FalseString"/>, <c>null</c> or <see cref="string.Empty"/>.</returns>
